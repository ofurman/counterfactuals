...
class AReS:
    ...
    def generate_counterfactuals(self, r=None):
...
class TwoLevelRecourseSet:
    ...
    def evaluate_triple(self, triple, ares):
        ...
        outer_ifs, inner_ifs, _ = list(triple[0]), list(triple[1]), list(triple[2])
    ...
    def triple_cost(triple, ares, x_aff):
        _, inner_ifs, thens = list(triple[0]), list(triple[1]), list(triple[2])
