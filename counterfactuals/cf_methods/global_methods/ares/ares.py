...
class AReS:
    ...
    def explain(
        ...
        q = 1 / self.X.shape[0]  # threshold for apriori during Then Generation
...
class TwoLevelRecourseSet:
    ...
    def evaluate_triple(self, triple, ares):
        ...
        triple_cfx = ares.X_aff_original.copy().astype(float)
        ...
        if triple_cover.any():
            ...
            if ares.normalise:
                ...
                corrects = ares.predict_fn(cfx_norm)
            else:
                corrects = ares.predict_fn(cfx.values)
