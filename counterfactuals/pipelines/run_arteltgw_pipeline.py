...
from counterfactuals.cf_methods.artelt_gw.artelt_gw import ArteltGW
...
def search_counterfactuals(
    ...
    cf_method: ArteltGW = instantiate(
...
@hydra.main(config_path="./conf", config_name="arteltgw_config", version_base="1.2")
