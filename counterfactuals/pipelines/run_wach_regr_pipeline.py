...
from counterfactuals.cf_methods.local_methods.regression_ppcef import WACH_REGR
...
def search_counterfactuals(
    ...
    """
    Generate counterfactuals using the WACH (regression) method.

    Prepares the WACH method with the generative and discriminative models, computes
...
@hydra.main(config_path="./conf", config_name="wach_regr_config", version_base="1.2")
def main(cfg: DictConfig) -> None:
    """
    Main pipeline for WACH counterfactual generation and evaluation (regression).

    Loads dataset and models, generates regression counterfactuals with WACH, and
