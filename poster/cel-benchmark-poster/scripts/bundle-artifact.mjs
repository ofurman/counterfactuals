...
if (imageFiles.length !== 14) throw new Error(`Expected five manuscript graphics, five header logos, one QR logo, and three Matplotlib examples from Parcel, found ${imageFiles.length}`)
