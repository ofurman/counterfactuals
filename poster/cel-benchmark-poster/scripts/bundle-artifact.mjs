...
if (imageFiles.length !== 13) throw new Error(`Expected four manuscript graphics, five header logos, one QR logo, and three Matplotlib examples from Parcel, found ${imageFiles.length}`)
