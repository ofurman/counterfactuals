...
4. **Applicability is evidence:** a compact note shows a missing AReS result without interpreting the missing-value marker as inapplicability. <!-- claims: global.blobs.ares.missing | sources: manuscript/tables/results_global.tex#tab:global_metrics_mlp -->
