...
**Header → Upper left → Upper right → Results → Bottom contributions.** The A1 portrait header uses the exact manuscript title and establishes
...
The full-width lower section combines global, local, group-wise, and regression findings in a two-by-two grid under one Results heading.
The contribution stack and project QR form the final full-width row below all results.
