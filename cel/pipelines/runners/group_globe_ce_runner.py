...
from cel.cf_methods import GLOBE_CE, AReS
...
from cel.pipelines.utils import one_hot
...
class GroupGLOBECEPipelineRunner(PipelineRunner):
    ...
    and performs KMeans clustering followed by per-cluster AReS + GLOBE-CE.
    """

    cf_method_name = "Group_Globe_CE"

    def run(self) -> None:
        """Custom run implementation for Group GLOBE-CE with raw dataset."""
