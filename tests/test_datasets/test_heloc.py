...
def test_heloc_initialization():
    # Construct absolute path to the config file
    project_root = Path(__file__).parent.parent.parent
    config_path = project_root / "config/datasets/heloc.yaml"
...
def test_heloc_ppcef_execution():
    """
    Integration test to verify that PPCEF pipeline runs on HELOC dataset.
    """
...
def test_heloc_globe_ce_execution():
    """
    Integration test to verify that GLOBE-CE pipeline runs on HELOC dataset.
    """
    with tempfile.TemporaryDirectory() as tmp_dir:
        GlobalHydra.instance().clear()
        config_dir = "../../counterfactuals/pipelines/conf"
